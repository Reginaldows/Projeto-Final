...
export default function EditarLivro() {
  ...
  const carregarLivro = async () => {
    try {
      ...
      if (!livro || livro.success === false) {
        setMensagem('Livro não encontrado');
        setTipoMensagem('erro');
        setTimeout(() => navigate('/bibliotecario'), 3000);
        return;
      }
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerContent}>
            ...
            <p className={styles.subtitulo}>Atualize as informações do livro no acervo da biblioteca</p>
          </div>
        </div>
        ...
        {carregando ? (
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.acoesContainer}>
              <button
                type="button"
                onClick={() => navigate('/bibliotecario')}
